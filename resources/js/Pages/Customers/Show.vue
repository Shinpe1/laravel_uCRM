                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div id="gender" class="w-ful bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div id="memo" v-html="nl2br(customer.memo)" name="memo" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">
